      ...
      {isClient && (
        <div className="relative min-h-screen bg-gradient-to-b h-full from-gray-800 to-gray-900">
          ...
          <div className="min-h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
            ...
            <h1 className="text-3xl md:text-6xl font-bold dark:text-white text-gray-400">
              Shape Your Future with{" "}
              <span className="text-blue-500">Placenext</span>
            </h1>
            <p className="text-base md:text-2xl font-light text-gray-400 dark:text-gray-300 mt-3">
